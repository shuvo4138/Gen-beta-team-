...
def get_chrome_driver(proxy: dict = None) -> tuple:
    ...
    FIX #33: Removed --single-process (causes segfault in multi-thread containers).
             Added --no-zygote and --disable-software-rasterizer for Railway stability.
    """
    options = Options()
    ...
    options.add_argument("--no-zygote")                        # FIX #33: Railway container stability
    options.add_argument("--disable-software-rasterizer")      # FIX #33: prevent GPU crash fallback
